...
{
	import com.michael.textmesh.ITextCompositor;
     ...
     */
    public class TextMesh extends DisplayObjectContainer
    {
        ...
        public function redraw():void
        {
            if (mRequiresRedraw)
            {
                if      (getCompositor(mFontName))   createComposedContents();
        ...
        private function createComposedContents():void
        {
            ...
            var bitmapFont:ITextCompositor = getCompositor(mFontName);
        ...
        public function set fontName(value:String):void
        {
            if (mFontName != value)
            {
                if (value == BitmapFont.MINI && bitmapFonts[value] == undefined)
                    registerBitmapFont(new TextMeshFont());
        ...
        public static function registerBitmapFont(bitmapFont:ITextCompositor, name:String=null):String
        {
