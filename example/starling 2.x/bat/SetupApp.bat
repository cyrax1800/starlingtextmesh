...
:: Android packaging
set AND_CERT_NAME="starling 2 test app"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\starling2testapp.p12
...
set IOS_PROVISION=cert\starling2testapp.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=starling2testapp
